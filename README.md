...
Важно: подготовка сервера изменяет UFW, sysctl, Docker daemon config и system limits. Используй её только на выделенной ноде под MTG, а не на общем сервере с другой рабочей нагрузкой.
